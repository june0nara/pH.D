...
from Camera import Camera  # Import the Camera class from the Camera.py file
...
# Control Page
# =============================================================================
class ControlPage(CNCRibbon.Page, Frame):
    __doc__ = _("CNC communication and control")
    _name_ = N_("Control")
    _icon_ = "control"

    def __init__(self, master, app, *args, **kwargs):
        CNCRibbon.Page.__init__(self, master, app, *args, **kwargs)
        ...
        # Add "Save Camera Feed" button
        self.saveCameraFeedButton = Button(self,
                                           text="이미지 저장",
                                           command=self.save_camera_feed_command)
        self.saveCameraFeedButton.pack()
    ...
    def save_camera_feed_command(self):
